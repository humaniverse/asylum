...
query_urls <-
  tibble::tribble(
    ...
    "returns_summary", "Returns summary table", "https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/1156949/returns-summary-mar-2023-tables.ods", "https://www.gov.uk/government/statistical-data-sets/immigration-system-statistics-data-tables-year-ending-march-2023#returns",
