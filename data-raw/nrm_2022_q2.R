...
nrm_referrals_govt_2022_q2_raw <-
...
nrm_referrals_police_2022_q2_raw <-
...
nrm_referrals_2022_q2 <-
  bind_rows(
    nrm_referrals_govt_2022_q2,
    nrm_referrals_ngo_2022_q2,
    nrm_referrals_police_2022_q2 |> filter(str_detect(`First responder`, "total")),  # Just take totals for Police
    nrm_referrals_la_2022_q2
  )
...
usethis::use_data(nrm_referrals_2022_q2, overwrite = TRUE)
readr::write_csv(nrm_referrals_2022_q2, "data-raw/nrm_referrals_2022_q2.csv")

usethis::use_data(nrm_referrals_govt_2022_q2, overwrite = TRUE)
readr::write_csv(nrm_referrals_govt_2022_q2, "data-raw/nrm_referrals_government_2022_q2.csv")

usethis::use_data(nrm_referrals_ngo_2022_q2, overwrite = TRUE)
readr::write_csv(nrm_referrals_ngo_2022_q2, "data-raw/nrm_referrals_ngo_2022_q2.csv")

usethis::use_data(nrm_referrals_police_2022_q2, overwrite = TRUE)
readr::write_csv(nrm_referrals_police_2022_q2, "data-raw/nrm_referrals_police_2022_q2.csv")

usethis::use_data(nrm_referrals_la_2022_q2, overwrite = TRUE)
readr::write_csv(nrm_referrals_la_2022_q2, "data-raw/nrm_referrals_local-authority_2022_q2.csv")

usethis::use_data(nrm_duty_to_notify_2022_q2, overwrite = TRUE)
readr::write_csv(nrm_duty_to_notify_2022_q2, "data-raw/nrm_duty_to_notify_2022_q2.csv")
