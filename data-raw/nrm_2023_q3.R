...
nrm_referrals_govt_2023_q3_raw <-
...
nrm_referrals_police_2023_q3_raw <-
...
nrm_referrals_2023_q3 <-
  bind_rows(
    nrm_referrals_govt_2023_q3,
    nrm_referrals_ngo_2023_q3,
    nrm_referrals_police_2023_q3 |> filter(str_detect(`First responder`, "total")),  # Just take totals for Police
    nrm_referrals_la_2023_q3
  )
...
usethis::use_data(nrm_referrals_2023_q3, overwrite = TRUE)
readr::write_csv(nrm_referrals_2023_q3, "data-raw/nrm_referrals_2023_q3.csv")

usethis::use_data(nrm_referrals_govt_2023_q3, overwrite = TRUE)
readr::write_csv(nrm_referrals_govt_2023_q3, "data-raw/nrm_referrals_government_2023_q3.csv")

usethis::use_data(nrm_referrals_ngo_2023_q3, overwrite = TRUE)
readr::write_csv(nrm_referrals_ngo_2023_q3, "data-raw/nrm_referrals_ngo_2023_q3.csv")

usethis::use_data(nrm_referrals_police_2023_q3, overwrite = TRUE)
readr::write_csv(nrm_referrals_police_2023_q3, "data-raw/nrm_referrals_police_2023_q3.csv")

usethis::use_data(nrm_referrals_la_2023_q3, overwrite = TRUE)
readr::write_csv(nrm_referrals_la_2023_q3, "data-raw/nrm_referrals_local-authority_2023_q3.csv")

usethis::use_data(nrm_duty_to_notify_2023_q3, overwrite = TRUE)
readr::write_csv(nrm_duty_to_notify_2023_q3, "data-raw/nrm_duty_to_notify_2023_q3.csv")
